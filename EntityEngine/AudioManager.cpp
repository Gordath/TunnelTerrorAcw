...
void AudioManager::set_listener_orientation(const glm::vec3 &dir, const glm::vec3 &up)
{
...
void AudioManager::play_sample(AudioSample *sample, float volume, AUDIO_PLAYMODE mode, const glm::vec3 &position, int *src_idx)
{
	...
	if (source){
		...
		source->set_looping(static_cast<bool>(mode));
