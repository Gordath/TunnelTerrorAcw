...
PipeItem::PipeItem(Mesh* m) : GameObject("pipeItem")
{
	...
	mat.textures[TEX_DIFFUSE] = Game::_resourceManager.Get<Texture_DX>(L"obstacle1Diff.png");
	mat.textures[TEX_SPECULAR] = Game::_resourceManager.Get<Texture_DX>(L"obstacle1Spec.png");
	mat.textures[TEX_NORMAL] = Game::_resourceManager.Get<Texture_DX>(L"obstacle1Norm.png");
	rc->SetMaterial(mat);
